...
cout << "Technology parameter reading" << endl;

//technology information

double C_bridge = 0.000000002;
double C_driver = 0.000000002;
double I_control = 0.002;
double R_ind = 50000000;
double R_sw = 0.001;
double Area_driver = 0.000001;
double Leak_sw = 1;
double Switching_loss = 0.0000001;
...
if(technology = 0)
{
C_bridge = 0.000000002;
C_driver = 0.000000002;
I_control = 0.002;
R_ind = 50000000;
R_sw = 0.037;
Area_driver = 0.000001;
Leak_sw = 1;
Switching_loss = 0.0000001;
Area_driver_controller = 0.05*0.000001; //0.05 mm2
L_density = 0.002;
C_density = 0.05;
}
...
{
cout << "please input technology" << endl;
exit(0);
}
